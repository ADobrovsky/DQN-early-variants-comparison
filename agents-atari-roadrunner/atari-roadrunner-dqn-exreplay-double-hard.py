...
TARGET_UPDATE = 500  # update rate for double deep Q-learning with hard update
...
MEMORY_SIZE = 50000
TYPE = 'atari-DQN-double-hard-update-dueling'
LR_NUM = "5-4"
...
for i_episode in range(num_episodes):
    ...
    for t in count():
        ...
        if steps_done % TARGET_UPDATE == 0:  # update target network every i episodes
