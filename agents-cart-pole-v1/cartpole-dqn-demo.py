...
# TODO specify the path to your saved models
PATH = 'C:/Users/'
# best (fast balance):
MODEL_FILE_NAME = 'DQN-fixed-target-soft-update-dueling-3layer-simple42-4-model.pt'
policy_net = DuelingDQN(n_observations, n_actions).to(device)  # init policy net
# bad model (not really interesting):
#MODEL_FILE_NAME = 'DQN-3layer-simple423-model.pt'
...
CRITERION_NAME = 'NONE'
wandb.init(project='ML-Test-cart-pole-DQN', save_code=True,
